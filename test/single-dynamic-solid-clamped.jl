cp("../examples/single/dynamic-solid/clamped/clamped.yaml", "clamped.yaml", force=true)
cp("../examples/single/dynamic-solid/clamped/clamped.g", "clamped.g", force=true)
...
@testset "single-dynamic-solid-clamped" begin
