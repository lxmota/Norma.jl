...
@testset "transfer-traction" begin
    ...
    src_mesh = Exodus.exodus("../examples/separate/transfer_tests/cube_coarse_nonconf.g")
    dst_mesh = Exodus.exodus("../examples/separate/transfer_tests/cube_fine_nonconf.g")
