cp("../examples/single/dynamic-solid/sho/sho.yaml", "sho.yaml", force=true)
cp("../examples/single/dynamic-solid/sho/sho.g", "sho.g", force=true)
...
@testset "single-dynamic-solid-sho" begin
